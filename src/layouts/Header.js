...
const Header = () => {
  ...
  const hours = {
    Sunday: { startTime: new Date('1970-01-01T08:00:00'), endTime: new Date('1970-01-01T16:00:00') },
    ...
    Saturday: { startTime: new Date('1970-01-01T07:00:00'), endTime: new Date('1970-01-01T17:00:00') },
  };
